    ...
    public partial class Addintialentitymodels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryBrances", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BranchHours_LibraryBrances_BranchId",
                        column: x => x.BranchId,
                        principalTable: "LibraryBrances",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(nullable: true),
                    NumberOfCopoes = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LibraryAssets_LibraryBrances_LocationId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Patrons_LibraryBrances_HomeLibraryBranchId",
                table: "Patrons",
                column: "HomeLibraryBranchId",
                principalTable: "LibraryBrances",
                principalColumn: "Id",
